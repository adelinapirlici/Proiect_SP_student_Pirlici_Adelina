...
% semnal triunghiular de perioadă T=40s, durata %D=18(conform tabelului), număr de coeficien?i N=50
P=40; %perioada semnalului
f=1/P; % frecventa = inversul perioadei
t=-2*P:0.002:2*P; % esantionarea semnalului original
D=0.45;  % am ales un D conform cerintei, numarul meu din tabel fiind 18 =>
% 18/40=0.45 ; 
N=50;
